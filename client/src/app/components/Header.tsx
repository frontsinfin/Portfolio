      ...
      <section className="md:w-[70%] col-span-2 flex flex-col gap-2 md:gap-3 md:py-4">
        ...
        <div className="flex flex-col gap-4">
          <p className="text-[14px] md:text-base text-center md:text-left">
            Я дизайнер и веб-разработчик из Санкт-Петербурга. Уже больше года я
            работаю и развиваюсь в этих сферах. За это время я успел реализовать
            несколько коммерческих проектов, занимаясь как дизайном, так и
            разработкой. Сейчас я стремлюсь взять на себя больше интересных
            проектов и улучшить свои навыки.
          </p>
